...
if (function(a) {
        a.extend({
            browserSelector: function() {
                ...
                var m = /Edge/.test(navigator.userAgent);
                m && a("html").removeClass("chrome").addClass("edge");
                var n = !window.ActiveXObject && "ActiveXObject" in window;
                return n ? void a("html").removeClass("gecko").addClass("ie ie11") : (a("body").hasClass("dark") && a("html").addClass("dark"), void(a("body").hasClass("boxed") && a("html").addClass("boxed")))
            }
        }), a.browserSelector()
    }(jQuery), function(a) {
        function b(a, b) {
            ...
            if (!(this.length < 1)) {
                ...
                if ("function" == typeof k.getBoundingClientRect) {
                    var o = k.getBoundingClientRect(),
                        ...
                        r = h ? o.left - j.left >= 0 && o.left < l + j.left - 50 : o.left >= 0 && o.left < l - 50,
                        s = h ? o.right - j.left > 0 && o.right < l + j.left - 50 : o.right > 0 && o.right <= l - 50,
                        t = c ? p || q : p && q,
                        u = c ? r || s : r && s,
        ...
        var b = -1,
            ...
            g = a.fn.matchHeight = function(b) {
                ...
                return this.length <= 1 ? this : (g._groups.push({
                    elements: this,
                    options: c
    ...
    */
    ...
    function(a, b) {
        fontSpy = function(a, c) {
            ...
            var g = {
                    font: f,
                    fontClass: f.toLowerCase().replace(/\s/g, ""),
                    success: function() {},
                    failure: function() {},
    ...
    var b = {
        ...
        build: function() {
            ...
            c > d ? (a("#footer").removeClass("footer-reveal"), a(".main").css("margin-bottom", 0)) : (a("#footer").addClass("footer-reveal"), a(".main").css("margin-bottom", c))
        },
        events: function() {
            var b = this,
                c = a(window);
    ...
    a.fn.extend({
        textRotator: function(b) {
            ...
            return this.each(function() {
                ...
                if (e.each(function() {
                        a(this).hide()
                    }), c.child) var f = c.child;
                else var f = a(d).children(":first");
                a(f).fadeIn(c.fadeSpeed, function() {
                    a(f).delay(c.pauseSpeed).fadeOut(c.fadeSpeed, function() {
                        var b = a(this).next();
                        0 == b.length && (b = a(d).children(":first")), a(d).textRotator({
                            child: b,
...
function(a) {
    var b = {
        ...
        build: function() {
            ...
            a(window).on("load", function() {
                setTimeout(function() {
                    b.$body.css({
                        "margin-top": b.$wrapper.outerHeight(),
                        transition: "ease margin 300ms"
                    }), a("#noticeTopBarContent").textRotator({
                        fadeSpeed: 500,
                        pauseSpeed: 5e3
                    })
                }, 1e3)
    ...
    a(".notice-top-bar").get(0) && b.init()
}(jQuery),
function(a) {
    a(".close-theme-switcher-bar").on("click", function() {
        a(this).closest(".header-top").css({
            height: 0,
            "min-height": 0,
            overflow: "hidden"
        })
...
function(a) {
    a('a[data-toggle="tab"]').on("shown.bs.tab", function(b) {
        var c = a(a(b.target).attr("href"));
        c.get(0) && c.find(".owl-carousel").trigger("refresh.owl.carousel")
    })
}(jQuery),
function(a) {
        ...
        return a.browser.mobile ? void 0 : this.each(function() {
            ...
            function d(a) {
                var b = g.innerWidth(),
                    ...
                    n = 180 * m / Math.PI - 90;
                0 > n && (n += 360), g.css({
                    transform: "perspective(1000px) rotateY(" + i / 2 + "deg) rotateX(" + j / 2 + "deg) translate3d(" + i / 2 + "px, 0, 0) scale(1.05)"
                }), g.find(".thumb-info-action").css({
                    transform: "perspective(1000px) rotateY(" + i / 5 + "deg) rotateX(" + j / 5 + "deg) translate3d(" + i / 5 + "px, " + (j / 5 - 15) + "px, 0)"
                });
                var o = j / 5 + "px";
                "50%" == g.find(".thumb-info-title").css("top") && (o = j / 5 - 47 + "%"), g.find(".thumb-info-title").css({
                    transform: "perspective(1000px) rotateY(" + i / 5 + "deg) rotateX(" + j / 5 + "deg) translate3d(" + i / 5 + "px, " + o + ", 0)"
...
function(a) {
    ...
    function h(a, b, c, d) {
        a.addClass("in").removeClass("out"), a.is(":last-child") ? (b.parents(".word-rotator").hasClass("type") && setTimeout(function() {
            ...
            e(b)
        }, l), b.closest(".word-rotator").hasClass("type") || b.closest(".word-rotator-words").animate({
            width: b.outerWidth()
        })) : setTimeout(function() {
            h(a.next(), b, c, d)
        }, d)
    ...
    function k(a, b) {
        if (a.removeClass("is-visible").addClass("is-hidden"), b.removeClass("is-hidden").addClass("is-visible"), !b.closest(".word-rotator").hasClass("clip")) {
            var c = 0,
                d = b.outerWidth() > a.outerWidth() ? 0 : 600;
            (b.closest(".word-rotator").hasClass("loading-bar") || b.closest(".word-rotator").hasClass("slide")) && (c = 3, d = 0), setTimeout(function() {
                b.closest(".word-rotator-words").animate({
                    width: b.outerWidth() + c
                })
            }, d)
        }
    }
