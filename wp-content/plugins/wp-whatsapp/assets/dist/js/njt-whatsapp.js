(() => {
                ...
                t.exports = function() {
                    ...
                    var y = function(t) {
                        ...
                        $ = function(t, e, n) {
                            var s;
                            if (!t) return w;
                            if ("string" == typeof t) b[t] && (s = t), e && (b[t] = e, s = t);
                            else {
                                var i = t.name;
                                b[i] = t, s = i
                            }
                            return !n && s && (w = s), s || !n && w
                        },
                        x = function(t, e) {
                    ...
                    var k = function() {
                            ...
                            return v.parse = function(t) {
                                ...
                                var n, c = M.p(t),
                                    l = "set" + (this.$u ? "UTC" : ""),
                                    f = (n = {}, n[o] = l + "Date", n[p] = l + "Date", n[u] = l + "Month", n[d] = l + "FullYear", n[a] = l + "Hours", n[r] = l + "Minutes", n[i] = l + "Seconds", n[s] = l + "Milliseconds", n)[c],
                                ...
                                var h = M.p(l),
                                    m = function(t) {
                                        var e = x(f);
                                        return M.w(e.date(e.date() + Math.round(t * s)), f)
                                    };
                                if (h === u) return this.set(u, this.$M + s);
                                if (h === d) return this.set(d, this.$y + s);
                                if (h === o) return m(1);
                                if (h === c) return m(7);
                                var g = (p = {}, p[r] = e, p[a] = n, p[i] = t, p)[h] || 1,
                                ...
                                var n = t || "YYYY-MM-DDTHH:mm:ssZ",
                                    ...
                                    u = i.months,
                                    l = function(t, s, i, r) {
                                        return t && (t[s] || t(e, n)) || i[s].substr(0, r)
                                    },
                                    d = function(t) {
                                ...
                                var h, m = M.p(p),
                                    ...
                                    _ = this - g,
                                    w = M.m(this, g);
                                return w = (h = {}, h[d] = w / 12, h[u] = w, h[l] = w / 3, h[c] = (_ - v) / 6048e5, h[o] = (_ - v) / 864e5, h[a] = _ / n, h[r] = _ / e, h[i] = _ / t, h)[m] || _, f ? w : M.a(w)
                    ...
                    }, x.locale = $, x.isDayjs = y, x.unix = function(t) {
                        return x(1e3 * t)
                    }, x.en = b[w], x.Ls = b, x.p = {}, x
                }()
            },
            646: function(t) {
                t.exports = function() {
                    ...
                    var t, e, n = 1e3,
                        ...
                        _ = function() {
                            function h(t, e, n) {
                                var s = this;
                                if (this.$d = {}, this.$l = n, void 0 === t && (this.$ms = 0, this.parseFromMilliseconds()), e) return p(t * l[f(e)], this);
                            ...
                            return g.calMilliseconds = function() {
                                ...
                                var t = this.$ms;
                                this.$d.years = m(t / o), t %= o, this.$d.months = m(t / c), t %= c, this.$d.days = m(t / r), t %= r, this.$d.hours = m(t / i), t %= i, this.$d.minutes = m(t / s), t %= s, this.$d.seconds = m(t / n), t %= n, this.$d.milliseconds = t
                                ...
                                var o = v(a, "S"),
                                    c = t.negative || e.negative || s.negative || i.negative || r.negative || o.negative,
                                    u = i.format || r.format || o.format ? "T" : "",
                                    l = (c ? "-" : "") + "P" + t.format + e.format + s.format + u + i.format + r.format + o.format;
                                ...
                                var s;
                                return s = e ? t * l[f(e)] : d(t) ? t.$ms : p(t, this).$ms, p(this.$ms + s * (n ? -1 : 1), this)
                    ...
                    return function(n, s, i) {
                        ...
                        c.tz = function(t, e) {
                            ...
                            var n = this.utcOffset(),
                                ...
                                c = i(a).$set("millisecond", this.$ms).utcOffset(15 * -Math.round(s.getTimezoneOffset() / 15) - o, !0);
                            if (e) {
                                var u = c.utcOffset();
                                c = c.add(n - u, "minute")
                            }
                ...
                t.exports = function() {
                    ...
                    return function(s, i, r) {
                        ...
                        a.utcOffset = function(s, i) {
                            var r = this.$utils().u;
                            if (r(s)) return this.$u ? 0 : r(this.$offset) ? u.call(this) : this.$offset;
                            ...
                            if (0 !== s) {
                                ...
                                (o = this.local().add(a + c, t)).$offset = a, o.$x.$localOffset = c
                            } else o = this.utc();
                            return o
                        };
                        var l = a.format;
    ...
    n.n = t => {
        ...
        var t = n(484),
            ...
            o = n(387),
            c = n.n(o);
        e().extend(i()), e().extend(a()), e().extend(c());
        const u = e(),
                ...
                for (let s = 0; s < r.workHours.length; s++) {
                    ...
                    if (-1 === f(i, c)) {
                        const s = p(c),
                            ...
                            f = ` ${r.get("hours")}${l.hour}:${r.get("minutes")}${l.minute} `;
                        return t.willBeBackText.replace(/\[njwa_time_work\]/gi, f)
                    }
                    if (0 === f(i, c) || 0 === f(i, l)) return "online";
            ...
            v = function(t, e) {
                if ("ON" == e.enabledFacebook || "ON" == e.enabledGoogle) {
                    var n = t.href,
                        s = n.indexOf("phone=") + 6,
                        i = n.indexOf("&text="); - 1 === i && (i = n.length);
                    ...
                    if ("ON" === e.enabledFacebook && "undefined" != typeof fbq && fbq("trackCustom", "NinjaTeam WhatsApp", {
                        ...
                        } else "undefined" != typeof __gaTracker && __gaTracker("send", "event", a, o, c);
        ...
        window.njtWhatsApp = {
            createButton: function(t, e) {
                const n = Object.assign({}, e),
                    ...
                    i = g(s, n);
                let r = "";
                r += "round" == n.styles.type ? " wa__r_button" : " wa__sq_button", r += "online" == i ? " wa__stt_online" : " wa__stt_offline", r += n.avatar ? " wa__btn_w_img" : " wa__btn_w_icon", r += n.name ? "" : " wa__button_text_only";
                let a = y(s, n);
                const o = document.createElement("div");
                o.setAttribute("class", n.avatar ? "wa__cs_img" : "wa__btn_icon"), o.appendChild((() => {
                    if (n.avatar) {
                ...
                c.setAttribute("class", "wa__btn_txt"), c.appendChild(n.name ? (() => {
                    ...
                    return t.className = "wa__cs_info", t.appendChild((() => {
                        const t = document.createElement("div");
                        return t.setAttribute("class", "wa__cs_name"), t.setAttribute("style", "online" == i ? `color: ${"#fff"==n.styles.textColor||"#ffffff"==n.styles.textColor?"#d5f0d9":n.styles.textColor}; opacity: ${"#fff"==n.styles.textColor||"#ffffff"==n.styles.textColor?1:.8}` : ""), t.innerHTML = n.name, t
                    })()), t.appendChild((() => {
                        const t = document.createElement("div");
                ...
                u.setAttribute("class", "nta-wa-gdpr"), u.appendChild((() => {
                ...
                l.setAttribute("target", "ON" == n.urlSettings.openInNewTab ? "_blank" : "_self"), l.setAttribute("href", a), l.setAttribute("rel", "nofollow noopener noreferrer"), l.setAttribute("class", "wa__button" + r), l.onclick = function(t) {
                    if (n.gdprStatus && !m("nta-wa-gdpr")) return t.preventDefault(), u.style.background = "red", void(u.style.color = "#fff");
                    v(this, {
                ...
                }, "online" == i && (l.style.backgroundColor = n.styles.backgroundColor), l.appendChild(o), l.appendChild(c), t.appendChild(l), n.gdprStatus && "accept" != m("nta-wa-gdpr") && t.appendChild(u), t._isWaButton = !0
            },
            createWidget: function(t, e) {
                ...
                i.setAttribute("class", "wa__btn_popup_txt"), i.appendChild((() => {
                    const t = document.createElement("span");
                    return t.innerHTML = s.btnLabel, t
                })()), i.style.display = "ON" == s.isShowBtnLabel ? "block" : "none", i.style.left = "left" == s.btnPosition ? "100%" : "unset", i.style.right = "right" == s.btnPosition ? "100%" : "unset", i.style.marginRight = "right" == s.btnPosition ? "7px" : "0px", i.style.marginLeft = "left" == s.btnPosition ? "7px" : "0px", i.style.width = s.btnLabelWidth + "px";
                ...
                a.setAttribute("class", "wa__btn_popup"), a.onclick = function() {
                    ...
                    const n = document.querySelector(".wa__popup_chat_box"),
                        s = document.querySelector(".wa__btn_popup");
                    n.classList.contains("wa__active") ? (n.classList.remove("wa__active"), s.classList.remove("wa__active"), clearTimeout(e), n.classList.contains("wa__lauch") && (t = setTimeout((function() {
                        n.classList.remove("wa__pending"), n.classList.remove("wa__lauch")
                    }), 400))) : (n.classList.add("wa__pending"), n.classList.add("wa__active"), s.classList.add("wa__active"), clearTimeout(t), n.classList.contains("wa__lauch") || (e = setTimeout((function() {
                        n.classList.add("wa__lauch")
                    }), 100)))
                }, a.appendChild(i), a.appendChild(r), a.style.left = "left" == s.btnPosition ? parseInt(s.btnLeftDistance) + "px" : "unset", a.style.right = "right" == s.btnPosition ? parseInt(s.btnRightDistance) + "px" : "unset", a.style.bottom = parseInt(s.btnBottomDistance) + "px", t.appendChild(a);
                const o = document.createElement("div");
                o.setAttribute("class", "wa__popup_heading"), o.style.background = s.backgroundColor, o.append((() => {
                    const t = document.createElement("div");
                    return t.className = "wa__popup_title", t.innerHTML = s.title, t.style.color = s.textColor, t
                })()), o.append((() => {
                    const t = document.createElement("div");
                    return t.className = "wa__popup_intro", t.innerHTML = s.description.replaceAll(/\r\n\r\n/gm, "<br/>"), t.style = "#fff" == s.textColor || "#ffffff" == s.textColor ? "color: #D9EBC6" : "color: " + s.textColor + "; opacity: 0.8", t
                })());
                const c = document.createElement("div");
                ...
                const u = document.createElement("div");
                u.className = "wa__popup_content wa__popup_content_left", u.appendChild((() => {
                    const t = document.createElement("div");
                    return t.className = "wa__popup_notice", t.innerHTML = s.responseText.replaceAll(/\r\n\r\n/gm, "<br/>"), t
                })()), u.appendChild("ON" == s.isShowGDPR && 1 == n.gdprStatus && "accept" != m("nta-wa-gdpr") ? c : document.createTextNode("")), u.appendChild((() => {
                    const t = document.createElement("div");
                    var e;
                    return t.className = "wa__popup_content_list", t.onclick = function() {
                        "" == m("nta-wa-gdpr") && (c.style.background = "red", c.style.color = "#fff")
                    }, e = t, n.accounts.forEach((t => {
                        const s = g(t, n);
                        let i = y(t, n);
                        const r = document.createElement("div");
                        r.className = "wa__popup_avatar" + (t.avatar ? "" : " nta-default-avt"), r.appendChild((() => {
                            if (t.avatar) {
                        ...
                        const a = document.createElement("div");
                        a.className = "wa__popup_content_item" + (n.gdprStatus ? " pointer-disable" : ""), a.appendChild((() => {
                            const e = document.createElement("a");
                            return e.setAttribute("target", "ON" == n.urlSettings.openInNewTab ? "_blank" : "_self"), e.setAttribute("href", i), e.setAttribute("rel", "nofollow noopener noreferrer"), e.className = "wa__stt" + ("online" === s ? " wa__stt_online" : " wa__stt_offline"), e.onclick = function() {
                                v(this, {
                                    enabledFacebook: n.options.analytics.enabledFacebook,
                                    enabledGoogle: n.options.analytics.enabledGoogle,
                                    enabledGoogleGA4: n.options.analytics.enabledGoogleGA4
                                ...
                                let n = "";
                                return n += `<div class="wa__member_name">${t.accountName}</div>`, n += `<div class="wa__member_duty">${t.title}</div>`, n += "online" != s ? `<div class="wa__member_status">${s}</div>` : "", e.innerHTML = n, e
                            })()), e
                        })()), e.appendChild(a)
                    })), t
                })());
                var l = '<a target="_blank" href="https://ninjateam.org/whatsapp-chat-wordpress/"><svg class="wa__popup_icon-ninja" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve"><g> <path class="st0" fill="#a9a9a9" d="M286.3,67C238,67,194,85.3,160.8,115.2l0-0.1l-13.2-27.8L84.9,49.2l8.5,66.4l27.1,21.1l-31.8-19.9l-60,8.9   l40.2,46.1l48.9,0.3C105.6,197,98.7,225,98.7,254.6c0,103.6,84,187.6,187.6,187.6s187.6-84,187.6-187.6S389.9,67,286.3,67z    M285.8,346.3c-111,0-171.9-63.2-171.9-92.5s62.2-91.5,171.9-91.5c109.5,0,172.8,62.1,172.8,91.5   C458.6,283.2,398.4,346.3,285.8,346.3z"/> <ellipse fill="#a9a9a9" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -77.6656 328.6796)" class="st1" cx="357.9" cy="258.1" rx="20.6" ry="20.6"/> <ellipse fill="#a9a9a9" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -119.8129 226.9269)" class="st1" cx="214" cy="258.1" rx="20.6" ry="20.6"/></g></svg></a>',
                    d = '<div class="wa__popup_powered_content">' + l + '<span class="wa__popup_tooltiptext"><svg class="wa__popup_icon-tooltip" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><path fill="#FFAC33" d="M32.938 15.651C32.792 15.26 32.418 15 32 15H19.925L26.89 1.458c.219-.426.106-.947-.271-1.243C26.437.071 26.218 0 26 0c-.233 0-.466.082-.653.243L18 6.588 3.347 19.243c-.316.273-.43.714-.284 1.105S3.582 21 4 21h12.075L9.11 34.542c-.219.426-.106.947.271 1.243.182.144.401.215.619.215.233 0 .466-.082.653-.243L18 29.412l14.653-12.655c.317-.273.43-.714.285-1.106z"/></svg> Powered by <span class="wa__popup_tooltiptext-ninja">NinjaTeam</span></span></div>',
                    p = '<span class="wa__popup_tooltiptext_mb"> POWERED BY' + l + '<span class="wa__popup_tooltiptext-ninja-mb">NINJATEAM</span></span>';
                "ON" === s.isShowPoweredBy && u.appendChild((() => {
                    const t = document.createElement("div");
                    return t.className = _ ? "wa__popup_powered_mb" : "wa__popup_powered", t.innerHTML = _ ? p : d, t
                })()), "ON" === s.isShowScroll && (u.style.maxHeight = parseInt(s.scrollHeight) + "px", u.style.overflow = "auto");
                const f = document.createElement("div");
                f.className = "wa__popup_chat_box", f.appendChild(o), f.style.left = "left" == s.btnPosition ? parseInt(s.btnLeftDistance) + "px" : "unset", f.style.right = "right" == s.btnPosition ? parseInt(s.btnRightDistance) + "px" : "unset", f.style.bottom = parseInt(s.btnBottomDistance) + 72 + "px", f.appendChild(u), t.appendChild(f)
            },
            ready: function(t) {
