...
! function(t) {
    ...
    return l.widget("ui.tabs", {
        ...
        _create: function() {
            var e = this,
                t = this.options;
            this.running = !1, this._addClass("ui-tabs", "ui-widget ui-widget-content"), this._toggleClass("ui-tabs-collapsible", null, t.collapsible), this._processTabs(), t.active = this._initialActive(), Array.isArray(t.disabled) && (t.disabled = l.uniqueSort(t.disabled.concat(l.map(this.tabs.filter(".ui-state-disabled"), function(t) {
        ...
        _setOptionDisabled: function(t) {
            var e, i;
            for (Array.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : t = !1), i = 0; e = this.tabs[i]; i++) e = l(e), !0 === t || -1 !== l.inArray(i, t) ? (e.attr("aria-disabled", "true"), this._addClass(e, null, "ui-state-disabled")) : (e.removeAttr("aria-disabled"), this._removeClass(e, null, "ui-state-disabled"));
        ...
        enable: function(i) {
            ...
            !1 !== t && (t = void 0 !== i && (i = this._getIndex(i), Array.isArray(t) ? l.map(t, function(t) {
                return t !== i ? t : null
